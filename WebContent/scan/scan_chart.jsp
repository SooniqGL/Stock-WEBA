...
<div class="contentwrapper"><div style="margin:2px;"> 
        ...
        <form name="scanForm" action="../s/scan_scanchart.do">
				<input type="hidden" id="inputVO.mode" name="inputVO.mode" value="chart"/>
		...
		<table width="100%"  class="gridtable" >
			...
			<tr class="light_back"><td colspan="2">&nbsp;&nbsp;<b>Scan Mode: </b>&nbsp;&nbsp;<select id="dropdown" name="dropdown" onchange="Q.scanchart.submitRequest()" class="dropdown"><option></option>
					<s:iterator var="modeVO" value="#modeList" status="rowStatus">
                        ...
                        <tr><td colspan="2">
                                <input type="button" name="button_prev" value="Prev" class="date_button" onClick="Q.scanchart.showChartWithShift('1')" <s:property value='%{#isPrevDisabled}'/> />
								<input type="button" name="button_next" value="Next" class="date_button" onClick="Q.scanchart.showChartWithShift('-1')" disabled />
                                <%-- try to list all the dates to here --%>
                                <select id="dateList" name="dateList" onchange="Q.scanchart.showChartFromDD()">
                        ...
                        <tr><td align="center" colspan="2"><img id="report_chart" src="../drawchart?chartType=SC&scanKey=<s:property value='%{inputVO.scanKey}'/>&scanIndex=0"></td></tr>
                        </s:if>
                        <s:else>
