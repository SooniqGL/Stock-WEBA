	...
	<tr>   
		...
		<tr class="gray_back"><td>Order</td><td>Ticker</td><td>Company</td><td>Comments</td><td>Price</td></tr>
			...
			<TD align="center" width="80">
				 <A href="../a/analyze.do?inputVO.mode=analyze&inputVO.pageStyle=S&inputVO.option=&inputVO.type=id&inputVO.ticker=<bean:write name='itemVO' property='ticker'/>&inputVO.period=6&inputVO.stockId=<bean:write name='itemVO' property='stockId'/>" class="datalink">
