 ...
 * @author Qin
 */
public class MarketCacheStore extends CacheBase {
    private Map cache = null;
    private static MarketCacheStore theObj = null;
    ...
    public static synchronized MarketCacheStore getInstance() {
        if (theObj == null) {
            theObj = new MarketCacheStore();
        }
    ...
    public void loadObject(String key, Object inputObj) throws Exception {
        if (key == null || key.equals("")) {
            throw new Exception("MarketCacheStore:loadObject: key is null.");
        }
        ...
        if (inputObj != null) {
            ...
            System.out.println("Warning: MarketCacheStore-loadObject() nothing for id: " + key);
        }
    }
    ...
    public void snap() {
            System.out.println("MarketCacheStore: " + cache.size() 
                    + ", put: " + putCacheCounter 
