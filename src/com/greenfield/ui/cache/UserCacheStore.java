...
public class UserCacheStore extends CacheBase {
    private Map cache = null;
    private static UserCacheStore theObj = null;
    ...
    public static synchronized UserCacheStore getInstance() {
        if (theObj == null) {
            theObj = new UserCacheStore();
        }
    ...
    public void loadObject(String key, Object inputObj) throws Exception {
        if (key == null || key.equals("")) {
            throw new Exception("UserCacheStore:loadObject: key is null.");
        }
        ...
        if (inputObj != null) {
            ...
            System.out.println("Warning: UserCacheStore-loadObject() nothing for id: " + key);
        }
    }
    ...
    public void snap() {
            System.out.println("UserCacheStore: " + cache.size() 
                    + ", put: " + putCacheCounter 
