 ...
 * @author Qin
 */
public class ScanCacheStore extends CacheBase {
    private Map cache = null;
    private static ScanCacheStore theObj = null;
    ...
    public static synchronized ScanCacheStore getInstance() {
        if (theObj == null) {
            theObj = new ScanCacheStore();
        }
    ...
    public void loadObject(String key, Object inputObj) throws Exception {
        if (key == null || key.equals("")) {
            throw new Exception("ScanCacheStore:loadObject: key is null.");
        }
        ...
        if (inputObj != null) {
            synchronized(cache) {
                ...
                // debug
                System.out.println("Push to cache: " + key);
            }
        } else {
            // nothing is found in DB, surprised!
            System.out.println("Warning: ScanCacheStore-loadObject() nothing for id: " + key);
        }
    }
    ...
    public void snap() {
            System.out.println("ScanCacheStore: " + cache.size() 
                    + ", put: " + putCacheCounter 
