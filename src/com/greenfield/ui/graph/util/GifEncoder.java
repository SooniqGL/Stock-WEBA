...
public class GifEncoder extends ImageEncoder
{
        ...
        throws IOException
    {
        ...
        for(int l = 0; l < height; l++) {
            ...
            for(int k1 = 0; k1 < width; k1++) {
                ...
                if(gifencoderhashitem == null) {
                    if (k >= 256) {
                    	// output - changed by qin, 6/16/2006
						// throw new IOException("too many colors for a GIF");
						//System.out.println("Error: too many colors for a GIF");
                    } else {
        ...
        GIFEncode(out, width, height, _$6316, (byte)0, i, byte0, abyte0, abyte1, abyte2);
    }
