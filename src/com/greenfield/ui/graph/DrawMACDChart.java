 ...
 */
public class DrawMACDChart extends BaseGraphics {
	...
	private int BAR_WIDTH = 3; // bar width in price chart
	...
	public void init() {
		...
		// for the MA lines
		thickStroke = new BasicStroke(2.8f, BasicStroke.CAP_BUTT, BasicStroke.CAP_ROUND);
	...
	public void paint() throws Exception {
		...
		BasicStroke regularThickStroke = new BasicStroke(2.3f, BasicStroke.CAP_BUTT, BasicStroke.CAP_ROUND);
